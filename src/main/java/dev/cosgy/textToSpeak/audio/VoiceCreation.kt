...
class VoiceCreation( // 各種設定の値を保持するためのフィールド
    ...
    private val dictionary: String? = bot.config.dictionaryDir
    private val voiceDirectory: String? = bot.config.voiceDir
    private val winJTalkDir: String? = bot.config.winJTalkDir
    private val maxMessageCount: Int = bot.config.maxMessageLength
