[![Downloads](https://img.shields.io/github/downloads/Cosgy-Dev/TextToSpeakBot/total.svg)](https://github.com/Cosgy-Dev/TextToSpeakBot/releases/latest)
...
## Docker
GitHub Packagesに**base**イメージと**full**イメージを用意しています。
- **base** MeCab、Open JTalkのみを含んだカスタマイズ可能な最小イメージ
- **full** base+辞書、ボイスデータ込みのそのままボットとして使えるイメージ

### 利用しているOSSとライセンス

本Dockerイメージは以下のOSSを利用しています。

- **MeCab**(GPL/LGPL/修正BSDライセンスのいずれかの条件下で利用可能) 本イメージでは修正BSDライセンスに基づき利用しています。
- **Open JTalk** 本イメージでは修正BSDライセンスに基づき利用しています。
- **HTS Voice "Mei"** fullイメージでCreative Commons Attribution 3.0ライセンスに基づき利用しています。
- **HTS Voice "Takumi"** fullイメージでCreative Commons Attribution 3.0ライセンスに基づき利用しています。
- **HTS Voice "tohoku-f01"** fullイメージでCreative Commons Attribution 4.0ライセンスに基づき利用しています。
