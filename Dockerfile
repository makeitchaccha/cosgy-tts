...
# OpenJTalk only, no dictionaries and voice models.
...
RUN wget https://github.com/icn-lab/htsvoice-tohoku-f01/archive/refs/heads/master.zip -O htsvoice-tohoku-f01.zip && \
    ...
    mv htsvoice-tohoku-f01-master/*.htsvoice /usr/share/hts-voice/ && \
    rm -R htsvoice-tohoku-f01.zip htsvoice-tohoku-f01-master
